...
namespace PeliculasAPI.Controllers
{
    ...
    public class GenerosController : ControllerBase
    {
        ...
        [HttpGet] //Sirve para leer informacion
        ...
        [HttpPost] //Sirve para mandar informacion
        ...
        [HttpPut("{id:int}")] //Sirve para actualizar informacion
        ...
        [HttpDelete("{id:int}")] //Sirve para borrar informacion
